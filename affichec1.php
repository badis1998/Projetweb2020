          ...
          <div class="col-xs-20">
            ...
            <table id="example1" class="table table-striped">
              ...
              <tr>
                ...
                <td><?php echo $res['date_commande']; ?></td>
                <td><?php echo $res['prix_total']; ?></td>

                <td <?php if ($res['etat'] == 0) { ?>class="warning" <?php } else { ?> class="success"><?php } ?> > <?php if ($res['etat'] == 0) { ?> <a href="modifer_commande.php?idcom=<?php echo $res['id_commande']; ?>"> <?php echo "preparation en cours"; ?> </a> <?php } else {
                                                                                                                                                                                                                                                                          echo "terminé";
                                                                                                                                                                                                                                                                        } ?></td>
